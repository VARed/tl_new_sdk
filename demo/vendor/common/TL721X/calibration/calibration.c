 ...
 * @return      none.
 */
void calibration_func(mspi_slave_device_num_e device_num)
{
    ...
    /******check for flash mid********/
    flash_mid_sure = flash_read_mid_uid_with_check_with_device_num(device_num,(unsigned int *)flash_mid, flash_uid);
